...
class OrganiseChatViewController: UIViewController {
    ...
    @IBAction func confirmBtn(_ sender: Any) {
        ...
        ref.updateChildValues(["Date1": self.dateSelected.text!, "Time1": self.timeSelected.text!, "Date2": self.date2.text!, "Time2": self.time2.text!, "Invite Type": "Interview Invite", "Response": "Pending Response", "First Date Response": "Pending Response", "Second Date Response": "Pending Response"])
        
        refBusiness.updateChildValues(["Date1": self.dateSelected.text!, "Time1": self.timeSelected.text!, "Date2": self.date2.text!, "Time2": self.time2.text!, "Invite Type": "Interview Invite", "Response": "Pending Response", "First Date Response": "Pending Response", "Second Date Response": "Pending Response"])
